...
object AppConfig {
    ...
    const val PREF_ROUTING_ACTIVE_PRESET = "pref_routing_active_preset"
    const val PREF_LITE_ROUTING_LEARNED_PROXY_DOMAINS = "pref_lite_routing_learned_proxy_domains"
    ...
    const val APP_API_URL = "https://api.github.com/repos/clcc2019/v2rayNG/releases"
    ...
    const val MSG_STATE_STARTING = 33
    const val MSG_STATE_STOP = 4
    const val MSG_STATE_STOP_SUCCESS = 41
    const val MSG_STATE_STOPPING = 42
    ...
    const val RAY_NG_CHANNEL_NAME = "XrayNG Background Service"
