...
2. 必读：`references/design-standards.md`
3. 必读：`references/page-rules.md`
4. 如果任务涉及首页主界面、节点列表卡片、底部 dock、顶栏分组、首页工具按钮，再读：`references/home-main-surface-system.md`
5. 读取当前页 + 至少 2 个同级页 + 共享 `colors/styles/drawable`
6. 首页任务默认额外检查这些实现落点：
...
7. 用 4 到 6 句总结“当前产品长什么样”和“这次问题属于不统一、信息层级混乱，还是组件本身不够成熟”
8. 先尝试通过共享 token / style / drawable / selector 解决；共享资源解决不了，再动单页结构和代码
